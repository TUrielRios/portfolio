  ...
  return (
    <div className="w-full grid grid-cols-9 gap-10 lgl:gap-0 px-6">
      ...
      <div className="col-span-9 md:col-span-4">
        <ResumeTitle title="Lenguajes" icon={<SiArtstation />} />
        {/* web Design */}
        <div className="py-4">
      ...
      <div className="col-span-9 md:col-span-4">
        ...
        <div className="py-4">
          ...
          {/* Hindi */}
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Inglés</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
              <span className="w-[90%] h-full absolute top-0 left-0 bg-designColor"></span>
            </span>
          </div>
          ...
          {/* French */}
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Portugués</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
      ...
      <div className="col-span-9 md:col-span-4">
        <ResumeTitle title="Tecnologías" icon={<BiCodeAlt />} />
        {/* web Design */}
        <div className="py-4">
          <div className="py-3 border-b-[1px] border-zinc-800">
          ...
          <div className="py-3 border-b-[1px] border-zinc-800">
            ...
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
              <span className="w-[90%] h-full absolute top-0 left-0 bg-designColor"></span>
                    ...
                    {/* Mobile Application */}
                    <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Sequelize</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
              <span className="w-[100%] h-full absolute top-0 left-0 bg-designColor"></span>
            </span>
          </div>
