  ...
  return (
    <section id="about" className={styles.aboutMe}>
      <div className={styles.aboutContent}>
        ...
        <p>
        I am a proficient full-stack web developer based in Buenos Aires, Argentina, with expertise in both PERN and MERN stacks. <br /><br /> My skill set includes HTML5, CSS3, JavaScript, TypeScript, React, Node, Sequelize, PostgreSQL, MongoDB, Next.js, Redux Toolkit, Express, and a variety of other cutting-edge technologies.
